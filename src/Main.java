...
public class Main {
    ...
    private static final String DEFAULT_FILENAME = "list.txt";
    ...
    private static void moveItem() {
        System.out.print("Enter item index to move: ");
    ...
    private static void promptToSave() {
        if (needsToBeSaved) {
            System.out.print("You have unsaved changes. Would you like to save them? (y/n): ");
